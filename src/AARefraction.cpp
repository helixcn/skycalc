...
RcppExport SEXP CAARefraction_RefractionFromApparent(SEXP Altitude_, SEXP Pressure_, SEXP Temperature_)
{
  double Altitude = as<double>(Altitude_); 
  double Pressure = as<double>(Pressure_); 
...
RcppExport SEXP CAARefraction_RefractionFromTrue(SEXP Altitude_, SEXP Pressure_, SEXP Temperature_)
{
  double Altitude = as<double>(Altitude_); 
  double Pressure = as<double>(Pressure_); 
  double Temperature = as<double>(Temperature_); 

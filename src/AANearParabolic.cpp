...
//// #################################################################################################
//// #################################################################################################
//// test: .Call("CAANearParabolic_Calculate", 2448188.5, 0.93858, 131.5856, 242.6797, 139.2313, 2448188.5, 2448188.5, 1)
//// 20131113
RcppExport SEXP CAANearParabolic_Calculate(SEXP JD_,  SEXP elements_q_, SEXP elements_i_, SEXP elements_w_ , 
                                           SEXP elements_omega_ ,SEXP elements_JDEquinox_ ,  SEXP elements_T_, 
                                           SEXP elements_e_)
{ 
  double JD = as<double>(JD_); 
  
  double elements_q         = as <double>(elements_q_        );
  double elements_i         = as <double>(elements_i_        );
  double elements_w         = as <double>(elements_w_        );
  double elements_omega     = as <double>(elements_omega_    );
  double elements_JDEquinox = as <double>(elements_JDEquinox_);
  double elements_T         = as <double>(elements_T_        );
  double elements_e         = as <double>(elements_e_        );

  CAANearParabolicObjectElements elements ;
  elements.q         = elements_q         ;
  elements.i         = elements_i         ;
  elements.w         = elements_w         ;
  elements.omega     = elements_omega     ;
  elements.JDEquinox = elements_JDEquinox ;
  elements.T         = elements_T         ; 
  elements.e         = elements_e         ;
  ...
  for (int j=0; j<2; j++)
  {
    double v;
    double r;
    CAANearParabolic::CalulateTrueAnnomalyAndRadius(JD0, elements, v, r);
  ...
  return List::create(Named("details.HeliocentricRectangularEquatorial.X")=details.HeliocentricRectangularEquatorial.X,
                       Named("details.HeliocentricRectangularEquatorial.Y")=details.HeliocentricRectangularEquatorial.Y,
                       Named("details.HeliocentricRectangularEquatorial.Z")=details.HeliocentricRectangularEquatorial.Z,
                       Named("details.HeliocentricRectangularEcliptical.X")=details.HeliocentricRectangularEcliptical.X,
                       Named("details.HeliocentricRectangularEcliptical.Y")=details.HeliocentricRectangularEcliptical.Y,
                       Named("details.HeliocentricRectangularEcliptical.Z")=details.HeliocentricRectangularEcliptical.Z,
                       Named("details.HeliocentricEclipticLongitude")=details.HeliocentricEclipticLongitude,
                       Named("details.HeliocentricEclipticLatitude")=details.HeliocentricEclipticLatitude,
                       Named("details.TrueGeocentricRA")=details.TrueGeocentricRA,
                       Named("details.TrueGeocentricDeclination")=details.TrueGeocentricDeclination,
                       Named("details.TrueGeocentricDistance")=details.TrueGeocentricDistance,
                       Named("details.TrueGeocentricLightTime")=details.TrueGeocentricLightTime,
                       Named("details.AstrometricGeocentricRA")=details.AstrometricGeocentricRA,
                       Named("details.AstrometricGeocentricDeclination")=details.AstrometricGeocentricDeclination,
                       Named("details.AstrometricGeocentricDistance")=details.AstrometricGeocentricDistance,
                       Named("details.AstrometricGeocentricLightTime")=details.AstrometricGeocentricLightTime,
                       Named("details.Elongation")=details.Elongation,
                       Named("details.PhaseAngle")=details.PhaseAngle
                       );
}

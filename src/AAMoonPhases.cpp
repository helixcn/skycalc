...
RcppExport SEXP CAAMoonPhases_K(SEXP Year_)
{
  double Year = as<double>(Year_);
  return wrap(12.3685*(Year - 2000));
}

RcppExport SEXP CAAMoonPhases_MeanPhase(SEXP k_)
{
  ...
  return wrap(2451550.09766 + 29.530588861*k + 0.00015437*T2 - 0.000000150*T3 + 0.00000000073*T4);
}

RcppExport SEXP CAAMoonPhases_TruePhase(SEXP k_)
{
  double k = as<double>(k_);
  //What will be the return value
  double JD = CAAMoonPhases::MeanPhase(k);

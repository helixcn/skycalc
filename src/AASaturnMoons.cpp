...
CAASaturnMoonsDetails CAASaturnMoons::CalculateHelper(double JD, double sunlongrad, double betarad, double R)
{
  ...
  if (a2 < 0)
    psi += 3.1415926535897932384626433832795;
...
RcppExport SEXP CAASaturnMoons_Calculate(SEXP JD_)
{
  ...
  //Calculate the details as seen from the earth
  CAASaturnMoonsDetails details1 = CAASaturnMoons::CalculateHelper(JD, sunlongrad, betarad, R);
  CAASaturnMoons::FillInPhenomenaDetails(details1.Satellite1);
  CAASaturnMoons::FillInPhenomenaDetails(details1.Satellite2);
  CAASaturnMoons::FillInPhenomenaDetails(details1.Satellite3);
  CAASaturnMoons::FillInPhenomenaDetails(details1.Satellite4);
  CAASaturnMoons::FillInPhenomenaDetails(details1.Satellite5);
  CAASaturnMoons::FillInPhenomenaDetails(details1.Satellite6);
  CAASaturnMoons::FillInPhenomenaDetails(details1.Satellite7);
  CAASaturnMoons::FillInPhenomenaDetails(details1.Satellite8);
  ...
  //Calculate the details as seen from the Sun
  CAASaturnMoonsDetails details2 = CAASaturnMoons::CalculateHelper(JD + SunLightTravelTime - EarthLightTravelTime, sunlongrad, betarad, 0);
  CAASaturnMoons::FillInPhenomenaDetails(details2.Satellite1);
  CAASaturnMoons::FillInPhenomenaDetails(details2.Satellite2);
  CAASaturnMoons::FillInPhenomenaDetails(details2.Satellite3);
  CAASaturnMoons::FillInPhenomenaDetails(details2.Satellite4);
  CAASaturnMoons::FillInPhenomenaDetails(details2.Satellite5);
  CAASaturnMoons::FillInPhenomenaDetails(details2.Satellite6);
  CAASaturnMoons::FillInPhenomenaDetails(details2.Satellite7);
  CAASaturnMoons::FillInPhenomenaDetails(details2.Satellite8);
  ...
  details1.Satellite8.bInShadowTransit = details2.Satellite8.bInTransit;
     ...
     List SateliteDetails = List::create(Named("Satellite1") = List::create(Named("Satellite1.TrueRectangularCoordinates.X") = details1.Satellite1.TrueRectangularCoordinates.X,
...
Named("Satellite1.ApparentRectangularCoordinates.X") = details1.Satellite1.ApparentRectangularCoordinates.X,
...
Named("Satellite1.bInTransit") = details1.Satellite1.bInTransit,
Named("Satellite1.bInOccultation") = details1.Satellite1.bInOccultation,
Named("Satellite1.bInEclipse") = details1.Satellite1.bInEclipse,
Named("Satellite1.bInShadowTransit") = details1.Satellite1.bInShadowTransit ),


Named("Satellite2") = List::create(Named("Satellite2.TrueRectangularCoordinates.X") = details1.Satellite2.TrueRectangularCoordinates.X,
...
Named("Satellite2.bInTransit") = details1.Satellite2.bInTransit,
Named("Satellite2.bInOccultation") = details1.Satellite2.bInOccultation,
...
Named("Satellite3") = List::create(Named("Satellite3.TrueRectangularCoordinates.X") = details1.Satellite3.TrueRectangularCoordinates.X,
Named("Satellite3.TrueRectangularCoordinates.Y") = details1.Satellite3.TrueRectangularCoordinates.Y,
Named("Satellite3.TrueRectangularCoordinates.Z") = details1.Satellite3.TrueRectangularCoordinates.Z,
...
Named("Satellite3.bInTransit") = details1.Satellite3.bInTransit,
Named("Satellite3.bInOccultation") = details1.Satellite3.bInOccultation,
...
Named("Satellite4") = List::create(Named("Satellite4.TrueRectangularCoordinates.X") = details1.Satellite4.TrueRectangularCoordinates.X,
...
Named("Satellite4.bInTransit") = details1.Satellite4.bInTransit,
Named("Satellite4.bInOccultation") = details1.Satellite4.bInOccultation,
...
Named("Satellite5") = List::create(Named("Satellite5.TrueRectangularCoordinates.X") = details1.Satellite5.TrueRectangularCoordinates.X,
Named("Satellite5.TrueRectangularCoordinates.Y") = details1.Satellite5.TrueRectangularCoordinates.Y,
Named("Satellite5.TrueRectangularCoordinates.Z") = details1.Satellite5.TrueRectangularCoordinates.Z,
Named("Satellite5.ApparentRectangularCoordinates.X") = details1.Satellite5.ApparentRectangularCoordinates.X,
Named("Satellite5.ApparentRectangularCoordinates.Y") = details1.Satellite5.ApparentRectangularCoordinates.Y,
Named("Satellite5.ApparentRectangularCoordinates.Z") = details1.Satellite5.ApparentRectangularCoordinates.Z,
Named("Satellite5.bInTransit") = details1.Satellite5.bInTransit,
Named("Satellite5.bInOccultation") = details1.Satellite5.bInOccultation,
Named("Satellite5.bInEclipse") = details1.Satellite5.bInEclipse,
Named("Satellite5.bInShadowTransit") = details1.Satellite5.bInShadowTransit ),

Named("Satellite6") = List::create(Named("Satellite6.TrueRectangularCoordinates.X") = details1.Satellite6.TrueRectangularCoordinates.X,
Named("Satellite6.TrueRectangularCoordinates.Y") = details1.Satellite6.TrueRectangularCoordinates.Y,
Named("Satellite6.TrueRectangularCoordinates.Z") = details1.Satellite6.TrueRectangularCoordinates.Z,
Named("Satellite6.ApparentRectangularCoordinates.X") = details1.Satellite6.ApparentRectangularCoordinates.X,
Named("Satellite6.ApparentRectangularCoordinates.Y") = details1.Satellite6.ApparentRectangularCoordinates.Y,
Named("Satellite6.ApparentRectangularCoordinates.Z") = details1.Satellite6.ApparentRectangularCoordinates.Z,
Named("Satellite6.bInTransit") = details1.Satellite6.bInTransit,
Named("Satellite6.bInOccultation") = details1.Satellite6.bInOccultation,
Named("Satellite6.bInEclipse") = details1.Satellite6.bInEclipse,
Named("Satellite6.bInShadowTransit") = details1.Satellite6.bInShadowTransit ),

Named("Satellite7") = List::create(Named("Satellite7.TrueRectangularCoordinates.X") = details1.Satellite7.TrueRectangularCoordinates.X,
Named("Satellite7.TrueRectangularCoordinates.Y") = details1.Satellite7.TrueRectangularCoordinates.Y,
Named("Satellite7.TrueRectangularCoordinates.Z") = details1.Satellite7.TrueRectangularCoordinates.Z,
Named("Satellite7.ApparentRectangularCoordinates.X") = details1.Satellite7.ApparentRectangularCoordinates.X,
Named("Satellite7.ApparentRectangularCoordinates.Y") = details1.Satellite7.ApparentRectangularCoordinates.Y,
Named("Satellite7.ApparentRectangularCoordinates.Z") = details1.Satellite7.ApparentRectangularCoordinates.Z,
Named("Satellite7.bInTransit") = details1.Satellite7.bInTransit,
Named("Satellite7.bInOccultation") = details1.Satellite7.bInOccultation,
Named("Satellite7.bInEclipse") = details1.Satellite7.bInEclipse,
Named("Satellite7.bInShadowTransit") = details1.Satellite7.bInShadowTransit ),

Named("Satellite8") = List::create(Named("Satellite8.TrueRectangularCoordinates.X") = details1.Satellite8.TrueRectangularCoordinates.X,
Named("Satellite8.TrueRectangularCoordinates.Y") = details1.Satellite8.TrueRectangularCoordinates.Y,
Named("Satellite8.TrueRectangularCoordinates.Z") = details1.Satellite8.TrueRectangularCoordinates.Z,
Named("Satellite8.ApparentRectangularCoordinates.X") = details1.Satellite8.ApparentRectangularCoordinates.X,
Named("Satellite8.ApparentRectangularCoordinates.Y") = details1.Satellite8.ApparentRectangularCoordinates.Y,
Named("Satellite8.ApparentRectangularCoordinates.Z") = details1.Satellite8.ApparentRectangularCoordinates.Z,
Named("Satellite8.bInTransit") = details1.Satellite8.bInTransit,
Named("Satellite8.bInOccultation") = details1.Satellite8.bInOccultation,
Named("Satellite8.bInEclipse") = details1.Satellite8.bInEclipse,
Named("Satellite8.bInShadowTransit") = details1.Satellite8.bInShadowTransit )
); 

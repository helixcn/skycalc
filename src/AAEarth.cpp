...
RcppExport SEXP CAAEarth_EclipticLongitude(SEXP JD_)
{ 
...
RcppExport SEXP CAAEarth_EclipticLatitude(SEXP JD_)
{ 
  double JD = as<double>(JD_); 
  double rho = (JD - 2451545) / 365250;
...
RcppExport SEXP CAAEarth_RadiusVector(SEXP JD_)
{ 
  double JD = as<double>(JD_); 
  double rho = (JD - 2451545) / 365250;
  double rhosquared = rho*rho;
  ...
  return wrap((R0 + R1*rho + R2*rhosquared + R3*rhocubed + R4*rho4) / 100000000);
}


RcppExport SEXP CAAEarth_EclipticLongitudeJ2000(SEXP JD_)
{ 
  double JD = as<double>(JD_); 
  double rho = (JD - 2451545) / 365250;
  double rhosquared = rho*rho;
...
RcppExport SEXP CAAEarth_EclipticLatitudeJ2000(SEXP JD_)
{ 
  double JD = as<double>(JD_); 
  double rho = (JD - 2451545) / 365250;
  double rhosquared = rho*rho;
...
RcppExport SEXP CAAEarth_SunMeanAnomaly(SEXP JD_)
{ 
  double JD = as<double>(JD_); 
  double T = (JD - 2451545) / 36525;
  double Tsquared = T*T;
  double Tcubed = Tsquared*T;
  return wrap(CAACoordinateTransformation::MapTo0To360Range(357.5291092 + 35999.0502909*T - 0.0001536*Tsquared + Tcubed/24490000));
}

RcppExport SEXP CAAEarth_Eccentricity(SEXP JD_)
{ 
  double JD = as<double>(JD_); 
  double T = (JD - 2451545) / 36525;
  double Tsquared = T*T;

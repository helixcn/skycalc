...
CAAGalileanMoonsDetails CAAGalileanMoons::CalculateHelper(double JD, double sunlongrad, double betarad, double R)
{
  ...
  double Sigma2 = 1.06476*sin(2*(l2rad - l3rad)) +
                  ...
                  -0.01057*sin(G) +
                  -0.00775*sin(2*(psi - PI_)) +
                  0.00524*sin(2*(l1rad - l2rad)) +
                  -0.00460*sin(l1rad - l3rad) +
                  0.00316*sin(psi - 2*G + w3rad - 2*PI_) +
                  -0.00203*sin(pi1 + pi3 - 2*PI_ - 2*G) +
  ...
  double Sigma3 = 0.16490*sin(l3rad - pi3) +
                  ...
                  0.00072*sin(pi1 + pi3 - 2*PI_ - 2*G) +
                  0.00069*sin(pi4 - PI_) +
                  -0.00058*sin(2*l3rad - 3*l4rad + pi4) +
                  -0.00057*sin(l3rad - 2*l4rad + pi4) +
                  0.00056*sin(l3rad + pi3 - 2*PI_ - 2*G) +
                  ...
                  0.00029*sin(l3rad + pi4 - 2*PI_ - 2*G) +
                  -0.00028*sin(w3rad + psi - 2*PI_ - 2*G) + 
                  0.00026*sin(l3rad - PI_ - G) +
                  0.00024*sin(l2rad - 3*l3rad + 2*l4rad) +
                  0.00021*sin(l3rad - PI_ - G) +
  ...
  double Sigma4 = 0.84287*sin(l4rad - pi4) +
                  0.03431*sin(pi4 - pi3) +
                  -0.03305*sin(2*(psi - PI_)) +
                  -0.03211*sin(G) +
                  -0.01862*sin(l4rad - pi3) +
                  0.01186*sin(psi - w4rad) +
                  0.00623*sin(l4rad + pi4 - 2*G - 2*PI_) +
  ...
  double B1 = atan(0.0006393*sin(L1 - w1rad) +
                   ...
                   0.0000046*sin(L1 + psi - 2*PI_ - 2*G));
  ...
  double B2 = atan(0.0081004*sin(L2 - w2rad) +
                   ...
                   0.0000143*sin(L2 + psi - 2*PI_ - 2*G) +
  ...
  double B3 = atan(0.0032402*sin(L3 - w3rad) +
                   ...
                   0.0000321*sin(L3 + psi - 2*PI_ - 2*G) +
                   0.0000051*sin(L3 - psi + G) +
                   -0.0000045*sin(L3 - psi - G) +
                   -0.0000045*sin(L3 + psi - 2*PI_) +
                   0.0000037*sin(L3 + psi - 2*PI_ - 3*G) +
  ...
  double B4 = atan(-0.0076579*sin(L4 - psi) +
                   ...
                   0.0000773*sin(L4 + psi - 2*PI_ - 2*G) +
                   0.0000104*sin(L4 - psi + G) +
                   -0.0000102*sin(L4 - psi - G) +
                   0.0000088*sin(L4 + psi - 2*PI_ - 3*G) +
                   -0.0000038*sin(L4 + psi - 2*PI_ - G));
  ...
  details.Satellite1.r = 5.90569 * (1 + (-0.0041339*cos(2*(l1rad - l2rad)) +
                                         ...
                                         -0.0000066*cos(l1rad + pi3 - 2*PI_ - 2*G)));
...
RcppExport SEXP CAAGalileanMoons_Calculate(SEXP JD_)
{
  ...
  //Calculate the details as seen from the earth
  CAAGalileanMoonsDetails details1 = CAAGalileanMoons::CalculateHelper(JD, sunlongrad, betarad, R);
  CAAGalileanMoons::FillInPhenomenaDetails(details1.Satellite1);
  CAAGalileanMoons::FillInPhenomenaDetails(details1.Satellite2);
  CAAGalileanMoons::FillInPhenomenaDetails(details1.Satellite3);
  CAAGalileanMoons::FillInPhenomenaDetails(details1.Satellite4);
  ...
  //Calculate the details as seen from the Sun
  CAAGalileanMoonsDetails details2 = CAAGalileanMoons::CalculateHelper(JD + SunLightTravelTime - EarthLightTravelTime, sunlongrad, betarad, 0);
  CAAGalileanMoons::FillInPhenomenaDetails(details2.Satellite1);
  CAAGalileanMoons::FillInPhenomenaDetails(details2.Satellite2);
  CAAGalileanMoons::FillInPhenomenaDetails(details2.Satellite3);

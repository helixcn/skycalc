...
RcppExport SEXP CAAEclipticalElements_Calculate(SEXP i0_, SEXP w0_, SEXP omega0_, SEXP JD0_, SEXP JD_)
{ 
double i0 = as<double>(i0_);
double w0 = as<double>(w0_);
double omega0 = as<double>(omega0_);
...
double JD = as<double>(JD_);
  ...
  return List::create(Named("i") =details.i, Named("omega") = details.omega, Named("w") = details.w);
}

RcppExport SEXP CAAEclipticalElements_FK4B1950ToFK5J2000(SEXP i0_, SEXP w0_, SEXP omega0_)
{  
  double i0 = as<double>(i0_);
  double w0 = as<double>(w0_);
  double omega0 = as<double>(omega0_);
  ...
  return List::create(Named("i") = details.i, Named("w") =details.w, Named("omega") =details.omega);
}

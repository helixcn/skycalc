...
RcppExport SEXP  CAAInterpolate_Interpolate3(SEXP n_, SEXP  Y1_, SEXP Y2_, SEXP Y3_)
{ 
  double n = as<double>(n_);
  double Y1 = as<double>(Y1_);
  double Y2 = as<double>(Y2_);
  double Y3 = as<double>(Y3_);
  
  double a = Y2 - Y1;
  double b = Y3 - Y2;
  double c = Y1 + Y3 - 2*Y2;

  return wrap(Y2 + n / 2 * (a + b + n*c));
}

RcppExport SEXP CAAInterpolate_Interpolate5(SEXP n_, SEXP  Y1_, SEXP Y2_, SEXP Y3_, SEXP Y4_, SEXP Y5_)
{ 
  double n = as<double>(n_);
  double Y1 = as<double>(Y1_);
  double Y2 = as<double>(Y2_);
  double Y3 = as<double>(Y3_);
  double Y4 = as<double>(Y4_);
  double Y5 = as<double>(Y5_);
  ...
  return wrap(Y3 + n*((B+C)/2 - (H+J)/12) + N2*(F/2 - K/24) + N3*((H+J)/12) + N4*(K/24));
}

RcppExport SEXP  CAAInterpolate_InterpolateToHalves4(SEXP Y1_, SEXP  Y2_, SEXP Y3_, SEXP Y4_)
{ 
  double Y1 = as<double>(Y1_);
  double Y2 = as<double>(Y2_);
  double Y3 = as<double>(Y3_);
  double Y4 = as<double>(Y4_);
  return wrap((9*(Y2 + Y3) - Y1 - Y4) / 16);
}

RcppExport SEXP  CAAInterpolate_Zero5_1(SEXP Y1_, SEXP  Y2_, SEXP  Y3_, SEXP Y4_, SEXP Y5_)
{ 
  double Y1 = as<double>(Y1_);
  double Y2 = as<double>(Y2_);
  double Y3 = as<double>(Y3_);
...
RcppExport SEXP  CAAInterpolate_Zero2(SEXP Y1_, SEXP  Y2_, SEXP  Y3_)
{ 
  double Y1 = as<double>(Y1_);
  double Y2 = as<double>(Y2_);
  double Y3 = as<double>(Y3_);
...
RcppExport SEXP CAAInterpolate_Zero5(SEXP Y1_, SEXP  Y2_, SEXP  Y3_, SEXP Y4_, SEXP Y5_)
{ 
  double Y1 = as<double>(Y1_);
  double Y2 = as<double>(Y2_);
  double Y3 = as<double>(Y3_);

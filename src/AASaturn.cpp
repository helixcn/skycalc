...
RcppExport SEXP CAASaturn_EclipticLongitude(SEXP JD_)
{ 
...
RcppExport SEXP CAASaturn_EclipticLatitude(SEXP JD_)
{ 
  double JD = as<double>(JD_); 
  double rho = (JD - 2451545) / 365250;
  double rhosquared = rho*rho;
...
RcppExport SEXP CAASaturn_RadiusVector(SEXP JD_)
{
  double JD = as<double>(JD_); 
  double rho = (JD - 2451545) / 365250;
  double rhosquared = rho*rho;

...
RcppExport SEXP CAAUranus_EclipticLongitude(SEXP JD_)
{
...
RcppExport SEXP CAAUranus_EclipticLatitude(SEXP JD_)
{ 
  double JD = as<double>(JD_);
  double rho = (JD - 2451545) / 365250;
  double rhosquared = rho*rho;
...
RcppExport SEXP CAAUranus_RadiusVector(SEXP JD_)
{
  double JD = as<double>(JD_);
  double rho = (JD - 2451545) / 365250;
  double rhosquared = rho*rho;

...
RcppExport SEXP CAANeptune_EclipticLongitude(SEXP JD_)
{
...
RcppExport SEXP CAANeptune_EclipticLatitude(SEXP JD_)
{ 
  double JD = as<double>(JD_); 
  double rho = (JD - 2451545) / 365250;
  double rhosquared = rho*rho;
...
RcppExport SEXP CAANeptune_RadiusVector(SEXP JD_)
{ 
  double JD = as<double>(JD_); 
  double rho = (JD - 2451545) / 365250;
  double rhosquared = rho*rho;
